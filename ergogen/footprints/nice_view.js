module.exports = {
  ...
  body: p => {
    ...
    const front = `
        ...
        (pad 10 smd rect (at -5.08 14.35 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.local_net("1").str})
        (pad 14 smd rect (at -5.08 13.45 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.MOSI.str})
        (pad 11 smd rect (at -2.54 14.35 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.local_net("2").str})
        (pad 15 smd rect (at -2.54 13.45 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.SCK.str})
        (pad 12 smd rect (at 2.54 14.35 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.local_net("4").str})
        (pad 16 smd rect (at 2.54 13.45 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.GND.str})
        (pad 13 smd rect (at 5.08 14.35 ${90 + p.rot}) (size 0.6 1.2) (layers F.Cu F.Mask) ${p.local_net("5").str})
    ...
    const back = `
        ...
        (pad 23 smd rect (at -5.08 14.35 ${270 + p.rot}) (size 0.6 1.2) (layers B.Cu B.Mask) ${p.local_net("1").str})
        (pad 20 smd rect (at 5.08 14.35 ${270 + p.rot}) (size 0.6 1.2) (layers B.Cu B.Mask) ${p.local_net("5").str})
        ...
        (pad 21 smd rect (at 2.54 14.35 ${270 + p.rot}) (size 0.6 1.2) (layers B.Cu B.Mask) ${p.local_net("4").str})
        (pad 22 smd rect (at -2.54 14.35 ${270 + p.rot}) (size 0.6 1.2) (layers B.Cu B.Mask) ${p.local_net("2").str})
    `

    const bottom = `
      (pad 5 thru_hole circle (at 5.08 16.7 ${270 + p.rot}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask)${p.local_net("5").str})
      (pad 4 thru_hole oval (at 2.54 16.7 ${270 + p.rot}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask)${p.local_net("4").str})
      (pad 2 thru_hole oval (at -2.54 16.7 ${270 + p.rot}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask)${p.local_net("2").str})
      (pad 1 thru_hole oval (at -5.08 16.7 ${270 + p.rot}) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("1").str})
